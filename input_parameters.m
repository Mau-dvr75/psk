...
if(plane_wave==0)
    ...
    f0=[0.15 0.15];%corner frequencies of the BP filter. The last value is a dummy
    ...
    STF_TYPE=[3,4]; %1=Gaussian/ 2=1st derivative of gaussian/ 3=ricker/ 4=user's time-domainSTF/
...
x0_source=[dltl-400000 dltl]; %This controls the delay of incoming plane wavefield
